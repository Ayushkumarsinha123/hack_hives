...
const paths = [
  {
    ...
    features: ['Screen reader support', 'High contrast modes', 'Text magnification']
  },
  {
  ...
  },
  {
    ...
    features: ['Simplified layouts', 'Step-by-step guides', 'Progress tracking']
  },
  {
    title: 'Communication Tools',
    icon: MessageSquare,
    description: 'Alternative communication methods',
    features: ['Text-to-speech', 'Speech-to-text', 'Symbol-based communication']
  }
];
...
export default function LearningPath() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4">
      {paths.map((path) => (
        <div key={path.title} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
